...
import { savequizgrades } from './handleGetCourses';
Modal.setAppElement('#root'); // Set the root element for accessibility

function QuizSubmissionModal({ isOpen, onRequestClose, module, courseId }) {
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} contentLabel="Student Submissions">
      ...
      <div style={{textAlign: 'center'}}>
        ...
        <button onClick={() => savequizgrades(grades,module.id-1,courseId)} style={buttonStyle}>Save Grades</button>
      </div>
